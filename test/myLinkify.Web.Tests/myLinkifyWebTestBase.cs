...
{
    public abstract class myLinkifyWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static myLinkifyWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(myLinkifyWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<myLinkifyDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<myLinkifyDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<myLinkifyDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<myLinkifyDbContext, Task<T>> func)
        {
            T result;
