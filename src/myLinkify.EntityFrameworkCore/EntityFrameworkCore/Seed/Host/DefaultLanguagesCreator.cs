...
namespace myLinkify.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly myLinkifyDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = myLinkifyConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(myLinkifyDbContext context)
        {
            _context = context;
        }
